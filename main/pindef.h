...
#define GPIO_MCPWM_UNIT0_PWM0A_OUT (GPIO_NUM_16)  // Set GPIO  4 as UNIT0_PWM0A
#define GPIO_MCPWM_UNIT0_PWM0B_OUT (GPIO_NUM_15)  // Set GPIO  5 as UNIT0_PWM0B
#define GPIO_MCPWM_UNIT0_PWM1A_OUT (GPIO_NUM_18)  // Set GPIO  6 as UNIT0_PWM1A
#define GPIO_MCPWM_UNIT0_PWM1B_OUT (GPIO_NUM_17)  // Set GPIO  7 as UNIT0_PWM1B
#define GPIO_MCPWM_ENABLE (GPIO_NUM_7)          // Set GPIO 15 as MCPWM global enable
