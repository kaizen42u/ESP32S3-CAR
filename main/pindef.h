...
#define GPIO_INPUT_PIN_SEL ((1ULL << GPIO_BUTTON_UP) | (1ULL << GPIO_BUTTON_DOWN) | (1ULL << GPIO_BUTTON_LEFT) | (1ULL << GPIO_BUTTON_RIGHT) | (1ULL << GPIO_BUTTON_SHOOT) | (1ULL << GPIO_BUTTON_TILT_LEFT) | (1ULL << GPIO_BUTTON_TILT_RIGHT))
